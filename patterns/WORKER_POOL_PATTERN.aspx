...
<title>Worker Pool Pattern | End-User Developed Applications</title>
<style>
...
<div id="app-container">
  <header class="guide-header">
    ...
    <span class="guide-subtitle">/ Worker Pool Pattern</span>
  </header>
  <div class="guide-body">
    <div class="prompt-banner">
      <div class="prompt-banner-text">
        <div class="prompt-banner-title">Building a worker pool?</div>
        <div class="prompt-banner-desc">Start with the Claude project prompt &mdash; attach it <strong>together with the Packaged Python prompt</strong> as your first message; this pattern builds on that one.</div>
      </div>
      <a class="prompt-banner-btn" href="WORKER_POOL_PROMPT.md">Open the Project Prompt</a>
    </div>
...
var MD_PATH    = PAGE_DIR + '/WORKER_POOL_PATTERN.md';
var DATA_FOLDER = PAGE_DIR + '/DEVELOPMENT_PATTERNS_data';
var PATTERN_ID  = 'worker-pool';
...
function boot() {
  ...
  fetch(apiUrl, { credentials: 'same-origin', headers: { 'Accept': 'text/plain' } })
    .then(function (r) {
      if (r.ok) return r.text();
      return fetch('./WORKER_POOL_PATTERN.md').then(function (r2) { return r2.text(); });
    })
    .catch(function () {
      return fetch('./WORKER_POOL_PATTERN.md').then(function (r2) { return r2.text(); });
    })
