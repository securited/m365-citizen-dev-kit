...
<title>SharePoint Permissions &amp; Auditing | End-User Developed Applications</title>
<style>
...
<div id="app-container">
  <header class="guide-header">
    ...
    <span class="guide-subtitle">/ SharePoint Permissions &amp; Auditing</span>
  </header>
  <div class="guide-body">
    <div class="prompt-banner">
      <div class="prompt-banner-text">
        <div class="prompt-banner-title">Adding access control to an app?</div>
        <div class="prompt-banner-desc">Start with the Claude project prompt &mdash; attach it <strong>together with the prompt for the app's own pattern</strong> as your first message; this pattern shapes the data model that prompt produces.</div>
      </div>
      <a class="prompt-banner-btn" href="SHAREPOINT_PERMISSIONS_PROMPT.md">Open the Project Prompt</a>
    </div>
...
var MD_PATH    = PAGE_DIR + '/SHAREPOINT_PERMISSIONS_PATTERN.md';
var DATA_FOLDER = PAGE_DIR + '/DEVELOPMENT_PATTERNS_data';
var PATTERN_ID  = 'sharepoint-permissions';
...
function boot() {
  ...
  fetch(apiUrl, { credentials: 'same-origin', headers: { 'Accept': 'text/plain' } })
    .then(function (r) {
      if (r.ok) return r.text();
      return fetch('./SHAREPOINT_PERMISSIONS_PATTERN.md').then(function (r2) { return r2.text(); });
    })
    .catch(function () {
      return fetch('./SHAREPOINT_PERMISSIONS_PATTERN.md').then(function (r2) { return r2.text(); });
    })
