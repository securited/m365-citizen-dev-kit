...
<title>SharePoint App Pattern | End-User Developed Applications</title>
<style>
...
<div id="app-container">
  <header class="guide-header">
    ...
    <span class="guide-subtitle">/ SharePoint App Pattern</span>
  </header>
  <div class="guide-body">
    <div class="prompt-banner">
      <div class="prompt-banner-text">
        <div class="prompt-banner-title">Building a new SharePoint app?</div>
      ...
      <a class="prompt-banner-btn" href="SHAREPOINT_APP_PROMPT.md">Open the Project Prompt</a>
    </div>
...
var MD_PATH    = PAGE_DIR + '/SHAREPOINT_APP_PATTERN.md';
var DATA_FOLDER = PAGE_DIR + '/DEVELOPMENT_PATTERNS_data';
var PATTERN_ID  = 'sharepoint-app';
...
function boot() {
  ...
  fetch(apiUrl, { credentials: 'same-origin', headers: { 'Accept': 'text/plain' } })
    .then(function (r) {
      if (r.ok) return r.text();
      return fetch('./SHAREPOINT_APP_PATTERN.md').then(function (r2) { return r2.text(); });
    })
    .catch(function () {
      return fetch('./SHAREPOINT_APP_PATTERN.md').then(function (r2) { return r2.text(); });
    })
