...
<title>Storage Shape &amp; Lifecycle | End-User Developed Applications</title>
<style>
...
<div id="app-container">
  <header class="guide-header">
    ...
    <span class="guide-subtitle">/ Storage Shape &amp; Lifecycle</span>
  </header>
  <div class="guide-body">
    <div class="prompt-banner">
      <div class="prompt-banner-text">
        <div class="prompt-banner-title">Designing a data model that will grow?</div>
        <div class="prompt-banner-desc">Start with the Claude project prompt &mdash; attach it <strong>together with the prompt for the app's own pattern</strong> as your first message; this pattern sizes and ages the data model that prompt produces.</div>
      </div>
      <a class="prompt-banner-btn" href="SHAREPOINT_STORAGE_LIFECYCLE_PROMPT.md">Open the Project Prompt</a>
    </div>
...
var MD_PATH    = PAGE_DIR + '/SHAREPOINT_STORAGE_LIFECYCLE_PATTERN.md';
var DATA_FOLDER = PAGE_DIR + '/DEVELOPMENT_PATTERNS_data';
var PATTERN_ID  = 'storage-lifecycle';
...
function inline(s) {
  ...
  s = s.replace(/\*([^*]+)\*/g, '<em>$1</em>');   /* after bold, so ** is already consumed */
...
function boot() {
  ...
  fetch(apiUrl, { credentials: 'same-origin', headers: { 'Accept': 'text/plain' } })
    .then(function (r) {
      if (r.ok) return r.text();
      return fetch('./SHAREPOINT_STORAGE_LIFECYCLE_PATTERN.md').then(function (r2) { return r2.text(); });
    })
    .catch(function () {
      return fetch('./SHAREPOINT_STORAGE_LIFECYCLE_PATTERN.md').then(function (r2) { return r2.text(); });
    })
